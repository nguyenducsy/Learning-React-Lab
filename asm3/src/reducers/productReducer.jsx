  ...
  switch (action.type) {    
    case DUA_PRO_VAO_STORE:
      ...
      action.arrPro.forEach( s => {
        state= [...state, 
          {id: s.id, name: s.name, price: s.price, urlPic:s.urlPic, urlPic2: s.urlPic2, des:s.des , idLoai: s.idLoai , new :s.new , hot :s.hot , star: s.star , sale: s.sale , view: s.view , sl: s.sl }
        ];
        });      
